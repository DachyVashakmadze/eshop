...
import { ThemingServiceService } from './services/theming-service.service';
...
export class AppComponent implements OnInit {
  ...
  constructor(public service: BaseProductService, public themingService: ThemingServiceService) { }
  ...
  ngOnInit(): void {
    /* აქ ხდება დაკვირვება აპლიკაციის როგორც მიმდინარე თემაზე, ასევე ამ თემის ცვლილებაზე.
     ...
     აქტიური თემის ცვლილებას ThemingServiceService აფიქსირებს და ყველა დამკვირვებელს - Observer-ს აგებინებს ამის შესახებ
     */
